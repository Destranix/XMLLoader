...
public final class LightTypeGroupTechniqueCommonGroupPoint
    extends XmlComplexType
{

    protected final static String ALLOWED_CHILDREN_PATTERN = "((color[ ]+){1}(constant_attenuation[ ]+){0,1}(linear_attenuation[ ]+){0,1}(quadratic_attenuation[ ]+){0,1}){1}";
    ...
    public LightTypeGroupTechniqueCommonGroupPoint(XmlComplexType elem) {
        super(elem, LightTypeGroupTechniqueCommonGroupPoint.class);
    }
        ...
        throws IOException
    {
        if (constantAttenuation == null) {
            try {
                constantAttenuation = ((TargetableFloatType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "constant_attenuation"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "targetable_float_type"), LightTypeGroupTechniqueCommonGroupPoint.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (linearAttenuation == null) {
            try {
                linearAttenuation = ((TargetableFloatType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "linear_attenuation"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "targetable_float_type"), LightTypeGroupTechniqueCommonGroupPoint.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (quadraticAttenuation == null) {
            try {
                quadraticAttenuation = ((TargetableFloatType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "quadratic_attenuation"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "targetable_float_type"), LightTypeGroupTechniqueCommonGroupPoint.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (color == null) {
            try {
                color = ((TargetableFloat3Type) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "color"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "targetable_float3_type"), LightTypeGroupTechniqueCommonGroupPoint.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
