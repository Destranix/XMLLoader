...
public final class InstanceRigidBodyTypeGroupTechniqueCommonGroupMassFrame
    extends XmlComplexType
{

    protected final static String ALLOWED_CHILDREN_PATTERN = "((translate[ ]+){1}|(rotate[ ]+){1}){0,}";
    ...
    public InstanceRigidBodyTypeGroupTechniqueCommonGroupMassFrame(XmlComplexType elem) {
        super(elem, InstanceRigidBodyTypeGroupTechniqueCommonGroupMassFrame.class);
    }
        ...
        throws IOException
    {
        if (translate == null) {
            try {
                translate = ((TranslateType[]) getChildren(new TranslateType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "translate"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "translate_type"), InstanceRigidBodyTypeGroupTechniqueCommonGroupMassFrame.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (rotate == null) {
            try {
                rotate = ((RotateType[]) getChildren(new RotateType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "rotate"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "rotate_type"), InstanceRigidBodyTypeGroupTechniqueCommonGroupMassFrame.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
