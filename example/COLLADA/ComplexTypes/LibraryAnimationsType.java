...
public final class LibraryAnimationsType
    extends XmlComplexType
{

    protected final static String ALLOWED_CHILDREN_PATTERN = "((asset[ ]+){0,1}(animation[ ]+){1,}(extra[ ]+){0,}){1}";
    ...
    static {
        ...
        try {
            ...
            ALLOWED_CHILDREN_MIN_BOUNDS.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "animation"), Integer.valueOf("1"));
    ...
    public LibraryAnimationsType(XmlComplexType elem) {
        super(elem, LibraryAnimationsType.class);
    }
        ...
        throws IOException
    {
        if (animation == null) {
            try {
                animation = ((AnimationType[]) getChildren(new AnimationType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "animation"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "animation_type"), LibraryAnimationsType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (extra == null) {
            try {
                extra = ((ExtraType[]) getChildren(new ExtraType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra_type"), LibraryAnimationsType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (asset == null) {
            try {
                asset = ((AssetType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "asset"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "asset_type"), LibraryAnimationsType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
