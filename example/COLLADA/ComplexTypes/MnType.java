    ...
    extends XmlComplexType
{
        ...
        throws IOException
    {
        if (malignmark == null) {
            try {
                malignmark = ((MalignmarkType) getChild(new XmlQName(new URI("http://www.w3.org/1998/Math/MathML"), "malignmark"), new XmlQName(new URI("http://www.w3.org/1998/Math/MathML"), "malignmark.type"), MnType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (mglyph == null) {
            try {
                mglyph = ((MglyphType) getChild(new XmlQName(new URI("http://www.w3.org/1998/Math/MathML"), "mglyph"), new XmlQName(new URI("http://www.w3.org/1998/Math/MathML"), "mglyph.type"), MnType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
