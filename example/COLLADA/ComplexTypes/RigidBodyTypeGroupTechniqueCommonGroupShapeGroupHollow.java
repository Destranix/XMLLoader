...
public final class RigidBodyTypeGroupTechniqueCommonGroupShapeGroupHollow
    extends XmlComplexType
{
    ...
    public RigidBodyTypeGroupTechniqueCommonGroupShapeGroupHollow(XmlComplexType elem) {
        super(elem, RigidBodyTypeGroupTechniqueCommonGroupShapeGroupHollow.class);
    }
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, RigidBodyTypeGroupTechniqueCommonGroupShapeGroupHollow.class);
        }
