...
public final class LinkTypeGroupGroup1AttachmentFull
    extends XmlComplexType
{

    protected final static String ALLOWED_CHILDREN_PATTERN = "(((rotate[ ]+){1}|(translate[ ]+){1}){0,}(link[ ]+){1}){1}";
    ...
    static {
        ...
        try {
            ...
            ALLOWED_CHILDREN_MIN_BOUNDS.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "link"), Integer.valueOf("1"));
            ALLOWED_CHILDREN_MAX_BOUNDS.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "link"), Integer.valueOf("1"));
    ...
    public LinkTypeGroupGroup1AttachmentFull(XmlComplexType elem) {
        super(elem, LinkTypeGroupGroup1AttachmentFull.class);
    }
        ...
        throws IOException
    {
        if (link == null) {
            try {
                link = ((LinkType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "link"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "link_type"), LinkTypeGroupGroup1AttachmentFull.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (translate == null) {
            try {
                translate = ((TranslateType[]) getChildren(new TranslateType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "translate"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "translate_type"), LinkTypeGroupGroup1AttachmentFull.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (rotate == null) {
            try {
                rotate = ((RotateType[]) getChildren(new RotateType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "rotate"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "rotate_type"), LinkTypeGroupGroup1AttachmentFull.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
