...
public final class SidrefArrayType
    extends XmlComplexType
{
    ...
    public SidrefArrayType(XmlComplexType elem) {
        super(elem, SidrefArrayType.class);
    }
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, SidrefArrayType.class);
        }
        ...
        if (XmlSimpleTypePlaceholder.class.isAssignableFrom((children[0].getClass()))) {
            ListOfSidrefsType newChild = new ListOfSidrefsType(((XmlSimpleTypePlaceholder)(children[0])), (((XmlSimpleTypePlaceholder) children[0]).getDataAsString()));
            newChild.setQualifiedName((this.qualifiedName));
            (children)[ 0 ] = newChild;
        }
        return ((ListOfSidrefsType)(children[0])).getValue();
    }
