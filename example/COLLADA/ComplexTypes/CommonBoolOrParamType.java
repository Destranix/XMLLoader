...
public final class CommonBoolOrParamType
    extends XmlComplexType
{

    protected final static String ALLOWED_CHILDREN_PATTERN = "((bool[ ]+){1}|(param[ ]+){1}){0,1}";
    ...
    public CommonBoolOrParamType(XmlComplexType elem) {
        super(elem, CommonBoolOrParamType.class);
    }
        ...
        throws IOException
    {
        if (param == null) {
            try {
                param = ((CommonParamType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "param"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "common_param_type"), CommonBoolOrParamType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (bool == null) {
            try {
                bool = ((XmlBoolean) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "bool"), new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "boolean"), CommonBoolOrParamType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
