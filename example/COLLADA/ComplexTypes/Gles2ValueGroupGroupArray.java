...
public final class Gles2ValueGroupGroupArray
    extends XmlComplexType
{

    protected final static String ALLOWED_CHILDREN_PATTERN = "((((bool[ ]+){1}|(bvec2[ ]+){1}|(bvec3[ ]+){1}|(bvec4[ ]+){1}|(float[ ]+){1}|(vec2[ ]+){1}|(vec3[ ]+){1}|(vec4[ ]+){1}|(mat2[ ]+){1}|(mat3[ ]+){1}|(mat4[ ]+){1}|(int[ ]+){1}|(ivec2[ ]+){1}|(ivec3[ ]+){1}|(ivec4[ ]+){1}|(enum[ ]+){1}|(sampler2D[ ]+){1}|(sampler3D[ ]+){1}|(samplerCUBE[ ]+){1}|(samplerDEPTH[ ]+){1}|(usertype[ ]+){1}|(array[ ]+){1}){0,1}){1,}){1}";
    ...
    public Gles2ValueGroupGroupArray(XmlComplexType elem) {
        super(elem, Gles2ValueGroupGroupArray.class);
    }
        ...
        throws IOException
    {
        if (samplerDEPTH == null) {
            try {
                samplerDEPTH = ((FxSamplerDEPTHType[]) getChildren(new FxSamplerDEPTHType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "samplerDEPTH"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_samplerDEPTH_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (usertype == null) {
            try {
                usertype = ((Gles2ValueGroupGroupUsertype[]) getChildren(new Gles2ValueGroupGroupUsertype[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "usertype"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "gles2_value_group/group/usertype"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (mat4 == null) {
            try {
                mat4 = ((Float4x4Type[]) getChildren(new Float4x4Type[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "mat4"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "float4x4_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (enumValue == null) {
            try {
                enumValue = ((GlEnumerationType[]) getChildren(new GlEnumerationType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "enum"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "gl_enumeration_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (sampler3D == null) {
            try {
                sampler3D = ((FxSampler3DType[]) getChildren(new FxSampler3DType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "sampler3D"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_sampler3D_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (mat2 == null) {
            try {
                mat2 = ((Float2x2Type[]) getChildren(new Float2x2Type[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "mat2"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "float2x2_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (mat3 == null) {
            try {
                mat3 = ((Float3x3Type[]) getChildren(new Float3x3Type[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "mat3"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "float3x3_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (floatValue == null) {
            try {
                floatValue = ((FloatType[]) getChildren(new FloatType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "float"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "float_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (vec4 == null) {
            try {
                vec4 = ((Float4Type[]) getChildren(new Float4Type[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "vec4"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "float4_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (ivec3 == null) {
            try {
                ivec3 = ((Int3Type[]) getChildren(new Int3Type[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "ivec3"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "int3_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (ivec4 == null) {
            try {
                ivec4 = ((Int4Type[]) getChildren(new Int4Type[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "ivec4"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "int4_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (vec2 == null) {
            try {
                vec2 = ((Float2Type[]) getChildren(new Float2Type[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "vec2"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "float2_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (bvec4 == null) {
            try {
                bvec4 = ((Bool4Type[]) getChildren(new Bool4Type[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "bvec4"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "bool4_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (vec3 == null) {
            try {
                vec3 = ((Float3Type[]) getChildren(new Float3Type[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "vec3"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "float3_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (ivec2 == null) {
            try {
                ivec2 = ((Int2Type[]) getChildren(new Int2Type[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "ivec2"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "int2_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (intValue == null) {
            try {
                intValue = ((IntType[]) getChildren(new IntType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "int"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "int_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (samplerCUBE == null) {
            try {
                samplerCUBE = ((FxSamplerCUBEType[]) getChildren(new FxSamplerCUBEType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "samplerCUBE"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_samplerCUBE_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (array == null) {
            try {
                array = ((Gles2ValueGroupGroupArray[]) getChildren(new Gles2ValueGroupGroupArray[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "array"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "gles2_value_group/group/array"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (sampler2D == null) {
            try {
                sampler2D = ((FxSampler2DType[]) getChildren(new FxSampler2DType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "sampler2D"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_sampler2D_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (bvec3 == null) {
            try {
                bvec3 = ((Bool3Type[]) getChildren(new Bool3Type[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "bvec3"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "bool3_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (bool == null) {
            try {
                bool = ((XmlBoolean[]) getChildren(new XmlBoolean[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "bool"), new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "boolean"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (bvec2 == null) {
            try {
                bvec2 = ((Bool2Type[]) getChildren(new Bool2Type[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "bvec2"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "bool2_type"), Gles2ValueGroupGroupArray.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
