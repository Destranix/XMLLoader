...
public final class ProfileGlslType
    extends XmlComplexType
{
    ...
    protected GlslNewparamType[] newparam;
    protected ProfileGlslTypeGroupTechnique[] technique;
    ...
    static {
        ...
        try {
            ...
            CHILDREN_NAME_MAP.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "newparam"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "glsl_newparam_type"));
            ...
            CHILDREN_NAME_MAP.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "technique"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "profile_glsl_type/group/technique"));
    ...
    public ProfileGlslType(XmlComplexType elem) {
        super(elem, ProfileGlslType.class);
    }
        ...
        throws IOException
    {
        if (extra == null) {
            try {
                extra = ((ExtraType[]) getChildren(new ExtraType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra_type"), ProfileGlslType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (include == null) {
            try {
                include = ((FxIncludeType[]) getChildren(new FxIncludeType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "include"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_include_type"), ProfileGlslType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (asset == null) {
            try {
                asset = ((AssetType[]) getChildren(new AssetType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "asset"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "asset_type"), ProfileGlslType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (code == null) {
            try {
                code = ((FxCodeType[]) getChildren(new FxCodeType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "code"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_code_type"), ProfileGlslType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
    ...
    public GlslNewparamType[] getNewparam()
        throws IOException
    {
        if (newparam == null) {
            try {
                newparam = ((GlslNewparamType[]) getChildren(new GlslNewparamType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "newparam"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "glsl_newparam_type"), ProfileGlslType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
    ...
    public ProfileGlslTypeGroupTechnique[] getTechnique()
        throws IOException
    {
        if (technique == null) {
            try {
                technique = ((ProfileGlslTypeGroupTechnique[]) getChildren(new ProfileGlslTypeGroupTechnique[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "technique"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "profile_glsl_type/group/technique"), ProfileGlslType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
