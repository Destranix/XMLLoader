...
public final class RigidBodyTypeGroupTechniqueCommonGroupMassFrame
    extends XmlComplexType
{
    ...
    public RigidBodyTypeGroupTechniqueCommonGroupMassFrame(XmlComplexType elem) {
        super(elem, RigidBodyTypeGroupTechniqueCommonGroupMassFrame.class);
    }
        ...
        throws IOException
    {
        if (translate == null) {
            try {
                translate = ((TranslateType[]) getChildren(new TranslateType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "translate"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "translate_type"), RigidBodyTypeGroupTechniqueCommonGroupMassFrame.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (rotate == null) {
            try {
                rotate = ((RotateType[]) getChildren(new RotateType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "rotate"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "rotate_type"), RigidBodyTypeGroupTechniqueCommonGroupMassFrame.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
