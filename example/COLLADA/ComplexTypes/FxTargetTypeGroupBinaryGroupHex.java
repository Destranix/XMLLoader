...
public final class FxTargetTypeGroupBinaryGroupHex
    extends XmlComplexType
{
    ...
    public FxTargetTypeGroupBinaryGroupHex(XmlComplexType elem) {
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, FxTargetTypeGroupBinaryGroupHex.class);
        }
