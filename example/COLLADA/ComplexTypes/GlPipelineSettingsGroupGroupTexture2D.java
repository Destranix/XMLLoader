...
public final class GlPipelineSettingsGroupGroupTexture2D
    extends XmlComplexType
{
    ...
    static {
        ...
        try {
            ...
            CHILDREN_NAME_MAP.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "value"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_sampler2D_type"));
    ...
    public GlPipelineSettingsGroupGroupTexture2D(XmlComplexType elem) {
        super(elem, GlPipelineSettingsGroupGroupTexture2D.class);
    }
        ...
        throws IOException
    {
        if (param == null) {
            try {
                param = ((XmlNCName) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "param"), new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "NCName"), GlPipelineSettingsGroupGroupTexture2D.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (value == null) {
            try {
                value = ((FxSampler2DType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "value"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_sampler2D_type"), GlPipelineSettingsGroupGroupTexture2D.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
