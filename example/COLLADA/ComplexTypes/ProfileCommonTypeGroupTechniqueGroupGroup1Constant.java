...
public final class ProfileCommonTypeGroupTechniqueGroupGroup1Constant
    extends XmlComplexType
{

    protected final static String ALLOWED_CHILDREN_PATTERN = "((emission[ ]+){0,1}(reflective[ ]+){0,1}(reflectivity[ ]+){0,1}(transparent[ ]+){0,1}(transparency[ ]+){0,1}(index_of_refraction[ ]+){0,1}){1}";
    ...
    public ProfileCommonTypeGroupTechniqueGroupGroup1Constant(XmlComplexType elem) {
        super(elem, ProfileCommonTypeGroupTechniqueGroupGroup1Constant.class);
    }
        ...
        throws IOException
    {
        if (transparency == null) {
            try {
                transparency = ((FxCommonFloatOrParamType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "transparency"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_common_float_or_param_type"), ProfileCommonTypeGroupTechniqueGroupGroup1Constant.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (indexOfRefraction == null) {
            try {
                indexOfRefraction = ((FxCommonFloatOrParamType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "index_of_refraction"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_common_float_or_param_type"), ProfileCommonTypeGroupTechniqueGroupGroup1Constant.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (reflectivity == null) {
            try {
                reflectivity = ((FxCommonFloatOrParamType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "reflectivity"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_common_float_or_param_type"), ProfileCommonTypeGroupTechniqueGroupGroup1Constant.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (transparent == null) {
            try {
                transparent = ((FxCommonTransparentType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "transparent"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_common_transparent_type"), ProfileCommonTypeGroupTechniqueGroupGroup1Constant.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (emission == null) {
            try {
                emission = ((FxCommonColorOrTextureType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "emission"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_common_color_or_texture_type"), ProfileCommonTypeGroupTechniqueGroupGroup1Constant.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (reflective == null) {
            try {
                reflective = ((FxCommonColorOrTextureType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "reflective"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_common_color_or_texture_type"), ProfileCommonTypeGroupTechniqueGroupGroup1Constant.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
