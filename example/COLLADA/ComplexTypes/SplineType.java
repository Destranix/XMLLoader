    ...
    extends XmlComplexType
{
    ...
    protected SplineTypeGroupControlVertices controlVertices;
    ...
    static {
        ...
        try {
            ...
            CHILDREN_NAME_MAP.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "control_vertices"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "spline_type/group/control_vertices"));
    ...
    public SplineType(XmlComplexType elem) {
        super(elem, SplineType.class);
    }
        ...
        throws IOException
    {
        if (extra == null) {
            try {
                extra = ((ExtraType[]) getChildren(new ExtraType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra_type"), SplineType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
    ...
    public SplineTypeGroupControlVertices getControlVertices()
        throws IOException
    {
        if (controlVertices == null) {
            try {
                controlVertices = ((SplineTypeGroupControlVertices) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "control_vertices"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "spline_type/group/control_vertices"), SplineType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (source == null) {
            try {
                source = ((SourceType[]) getChildren(new SourceType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "source"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "source_type"), SplineType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
