    ...
    extends XmlComplexType
{
    ...
    public LinesType(XmlComplexType elem) {
        super(elem, LinesType.class);
    }
        ...
        throws IOException
    {
        if (extra == null) {
            try {
                extra = ((ExtraType[]) getChildren(new ExtraType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra_type"), LinesType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (p == null) {
            try {
                p = ((PType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "p"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "p_type"), LinesType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (input == null) {
            try {
                input = ((InputLocalOffsetType[]) getChildren(new InputLocalOffsetType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "input"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "input_local_offset_type"), LinesType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
