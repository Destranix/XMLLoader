...
public final class RigidConstraintTypeGroupTechniqueCommonGroupInterpenetrate
    extends XmlComplexType
{
    ...
    public RigidConstraintTypeGroupTechniqueCommonGroupInterpenetrate(XmlComplexType elem) {
        super(elem, RigidConstraintTypeGroupTechniqueCommonGroupInterpenetrate.class);
    }
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, RigidConstraintTypeGroupTechniqueCommonGroupInterpenetrate.class);
        }
