...
public final class AnnotationXmlType
    extends XmlComplexType
{

    protected final static String ALLOWED_CHILDREN_PATTERN = "((\\.*){1}){1}";
    ...
    public AnnotationXmlType(XmlComplexType elem) {
        super(elem, AnnotationXmlType.class);
    }
