...
public final class RigidBodyTypeGroupTechniqueCommonGroupDynamic
    extends XmlComplexType
{
    ...
    public RigidBodyTypeGroupTechniqueCommonGroupDynamic(XmlComplexType elem) {
        super(elem, RigidBodyTypeGroupTechniqueCommonGroupDynamic.class);
    }
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, RigidBodyTypeGroupTechniqueCommonGroupDynamic.class);
        }
