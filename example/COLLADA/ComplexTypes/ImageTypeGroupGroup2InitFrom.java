...
public final class ImageTypeGroupGroup2InitFrom
    extends XmlComplexType
{
    ...
    static {
        ALLOWED_ATTRIBUTES.add("mips_generate");
        ATTRIBUTE_DEFAULT_VALUES.put("mips_generate", "true");
        try {
            ATTRIBUTES_NAME_MAP.put("mips_generate", new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "boolean"));
    ...
    public ImageTypeGroupGroup2InitFrom(XmlComplexType elem) {
        super(elem, ImageTypeGroupGroup2InitFrom.class);
    }
        ...
        throws IOException
    {
        if (hex == null) {
            try {
                hex = ((ImageSourceTypeGroupHex) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "hex"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "image_source_type/group/hex"), ImageTypeGroupGroup2InitFrom.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (ref == null) {
            try {
                ref = ((XmlAnyURI) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "ref"), new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "anyURI"), ImageTypeGroupGroup2InitFrom.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
