...
public final class LibraryJointsType
    extends XmlComplexType
{

    protected final static String ALLOWED_CHILDREN_PATTERN = "((asset[ ]+){0,1}(joint[ ]+){1,}(extra[ ]+){0,}){1}";
    ...
    static {
        ...
        try {
            ...
            ALLOWED_CHILDREN_MIN_BOUNDS.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "joint"), Integer.valueOf("1"));
    ...
    public LibraryJointsType(XmlComplexType elem) {
        super(elem, LibraryJointsType.class);
    }
        ...
        throws IOException
    {
        if (extra == null) {
            try {
                extra = ((ExtraType[]) getChildren(new ExtraType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra_type"), LibraryJointsType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (joint == null) {
            try {
                joint = ((JointType[]) getChildren(new JointType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "joint"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "joint_type"), LibraryJointsType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (asset == null) {
            try {
                asset = ((AssetType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "asset"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "asset_type"), LibraryJointsType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
