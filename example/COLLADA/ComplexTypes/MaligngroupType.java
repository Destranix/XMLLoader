...
public final class MaligngroupType
    extends XmlComplexType
{
    ...
    static {
        ...
        try {
            ...
            ATTRIBUTES_NAME_MAP.put("groupalign", new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "attribute/type"));
    ...
    public MaligngroupType(XmlComplexType elem) {
        super(elem, MaligngroupType.class);
    }
