...
public final class MlabeledtrType
    extends XmlComplexType
{
    ...
    public MlabeledtrType(XmlComplexType elem) {
        super(elem, MlabeledtrType.class);
    }
        ...
        throws IOException
    {
        if (mtd == null) {
            try {
                mtd = ((MtdType) getChild(new XmlQName(new URI("http://www.w3.org/1998/Math/MathML"), "mtd"), new XmlQName(new URI("http://www.w3.org/1998/Math/MathML"), "mtd.type"), MlabeledtrType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
