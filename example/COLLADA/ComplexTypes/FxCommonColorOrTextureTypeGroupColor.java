...
public final class FxCommonColorOrTextureTypeGroupColor
    extends XmlComplexType
{
    ...
    public FxCommonColorOrTextureTypeGroupColor(XmlComplexType elem) {
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, FxCommonColorOrTextureTypeGroupColor.class);
        }
