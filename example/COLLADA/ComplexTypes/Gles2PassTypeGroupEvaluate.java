...
public final class Gles2PassTypeGroupEvaluate
    extends XmlComplexType
{

    protected final static String ALLOWED_CHILDREN_PATTERN = "((color_target[ ]+){0,}(depth_target[ ]+){0,}(stencil_target[ ]+){0,}(color_clear[ ]+){0,}(stencil_clear[ ]+){0,}(depth_clear[ ]+){0,}(draw[ ]+){0,1}){1}";
    ...
    public Gles2PassTypeGroupEvaluate(XmlComplexType elem) {
        super(elem, Gles2PassTypeGroupEvaluate.class);
    }
        ...
        throws IOException
    {
        if (draw == null) {
            try {
                draw = ((FxDrawType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "draw"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_draw_type"), Gles2PassTypeGroupEvaluate.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (colorClear == null) {
            try {
                colorClear = ((FxClearcolorType[]) getChildren(new FxClearcolorType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "color_clear"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_clearcolor_type"), Gles2PassTypeGroupEvaluate.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (depthClear == null) {
            try {
                depthClear = ((FxCleardepthType[]) getChildren(new FxCleardepthType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "depth_clear"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_cleardepth_type"), Gles2PassTypeGroupEvaluate.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (depthTarget == null) {
            try {
                depthTarget = ((FxDepthtargetType[]) getChildren(new FxDepthtargetType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "depth_target"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_depthtarget_type"), Gles2PassTypeGroupEvaluate.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (stencilClear == null) {
            try {
                stencilClear = ((FxClearstencilType[]) getChildren(new FxClearstencilType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "stencil_clear"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_clearstencil_type"), Gles2PassTypeGroupEvaluate.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (stencilTarget == null) {
            try {
                stencilTarget = ((FxStenciltargetType[]) getChildren(new FxStenciltargetType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "stencil_target"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_stenciltarget_type"), Gles2PassTypeGroupEvaluate.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (colorTarget == null) {
            try {
                colorTarget = ((FxColortargetType[]) getChildren(new FxColortargetType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "color_target"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_colortarget_type"), Gles2PassTypeGroupEvaluate.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
