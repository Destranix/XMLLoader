...
public final class InstanceGeometryType
    extends XmlComplexType
{

    protected final static String ALLOWED_CHILDREN_PATTERN = "((bind_material[ ]+){0,1}(extra[ ]+){0,}){1}";
    ...
    public InstanceGeometryType(XmlComplexType elem) {
        super(elem, InstanceGeometryType.class);
    }
        ...
        throws IOException
    {
        if (extra == null) {
            try {
                extra = ((ExtraType[]) getChildren(new ExtraType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra_type"), InstanceGeometryType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (bindMaterial == null) {
            try {
                bindMaterial = ((BindMaterialType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "bind_material"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "bind_material_type"), InstanceGeometryType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
