...
public final class IntArrayType
    extends XmlComplexType
{
    ...
    static {
        ALLOWED_ATTRIBUTES.add("minInclusive");
        ATTRIBUTE_DEFAULT_VALUES.put("minInclusive", "-2147483648");
        try {
            ATTRIBUTES_NAME_MAP.put("minInclusive", new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "integer"));
            ...
            ATTRIBUTES_NAME_MAP.put("maxInclusive", new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "integer"));
        ...
        ALLOWED_ATTRIBUTES.add("maxInclusive");
        ATTRIBUTE_DEFAULT_VALUES.put("maxInclusive", "2147483647");
    }

    public IntArrayType(XmlComplexType elem) {
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, IntArrayType.class);
        }
        ...
        if (XmlSimpleTypePlaceholder.class.isAssignableFrom((children[0].getClass()))) {
            ListOfIntsType newChild = new ListOfIntsType(((XmlSimpleTypePlaceholder)(children[0])), (((XmlSimpleTypePlaceholder) children[0]).getDataAsString()));
            newChild.setQualifiedName((this.qualifiedName));
            (children)[ 0 ] = newChild;
        }
        return ((ListOfIntsType)(children[0])).getValue();
    }
