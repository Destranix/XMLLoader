...
public final class LightTypeGroupTechniqueCommonGroupDirectional
    extends XmlComplexType
{
    ...
    public LightTypeGroupTechniqueCommonGroupDirectional(XmlComplexType elem) {
        super(elem, LightTypeGroupTechniqueCommonGroupDirectional.class);
    }
        ...
        throws IOException
    {
        if (color == null) {
            try {
                color = ((TargetableFloat3Type) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "color"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "targetable_float3_type"), LightTypeGroupTechniqueCommonGroupDirectional.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
