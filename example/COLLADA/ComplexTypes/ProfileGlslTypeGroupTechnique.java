...
public final class ProfileGlslTypeGroupTechnique
    extends XmlComplexType
{
    ...
    protected ProfileGlslTypeGroupTechniqueGroupPass[] pass;
    ...
    static {
        ...
        try {
            ...
            CHILDREN_NAME_MAP.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "pass"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "profile_glsl_type/group/technique/group/pass"));
    ...
    public ProfileGlslTypeGroupTechnique(XmlComplexType elem) {
        super(elem, ProfileGlslTypeGroupTechnique.class);
    }
        ...
        throws IOException
    {
        if (extra == null) {
            try {
                extra = ((ExtraType[]) getChildren(new ExtraType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra_type"), ProfileGlslTypeGroupTechnique.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (annotate == null) {
            try {
                annotate = ((FxAnnotateType[]) getChildren(new FxAnnotateType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "annotate"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_annotate_type"), ProfileGlslTypeGroupTechnique.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
    ...
    public ProfileGlslTypeGroupTechniqueGroupPass[] getPass()
        throws IOException
    {
        if (pass == null) {
            try {
                pass = ((ProfileGlslTypeGroupTechniqueGroupPass[]) getChildren(new ProfileGlslTypeGroupTechniqueGroupPass[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "pass"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "profile_glsl_type/group/technique/group/pass"), ProfileGlslTypeGroupTechnique.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (asset == null) {
            try {
                asset = ((AssetType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "asset"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "asset_type"), ProfileGlslTypeGroupTechnique.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
