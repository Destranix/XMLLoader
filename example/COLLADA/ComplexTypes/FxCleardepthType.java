...
public final class FxCleardepthType
    extends XmlComplexType
{
    ...
    public FxCleardepthType(XmlComplexType elem) {
        super(elem, FxCleardepthType.class);
    }
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, FxCleardepthType.class);
        }
