...
public final class MotionEffectorInfoType
    extends XmlComplexType
{
    ...
    static {
        ...
        try {
            ...
            CHILDREN_NAME_MAP.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "speed"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "common_float2_or_param_type"));
            ...
            CHILDREN_NAME_MAP.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "acceleration"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "common_float2_or_param_type"));
            ...
            CHILDREN_NAME_MAP.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "deceleration"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "common_float2_or_param_type"));
            ...
            CHILDREN_NAME_MAP.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "jerk"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "common_float2_or_param_type"));
    ...
    public MotionEffectorInfoType(XmlComplexType elem) {
        super(elem, MotionEffectorInfoType.class);
    }
        ...
        throws IOException
    {
        if (speed == null) {
            try {
                speed = ((CommonFloat2OrParamType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "speed"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "common_float2_or_param_type"), MotionEffectorInfoType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (acceleration == null) {
            try {
                acceleration = ((CommonFloat2OrParamType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "acceleration"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "common_float2_or_param_type"), MotionEffectorInfoType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (setparam == null) {
            try {
                setparam = ((KinematicsSetparamType[]) getChildren(new KinematicsSetparamType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "setparam"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "kinematics_setparam_type"), MotionEffectorInfoType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (deceleration == null) {
            try {
                deceleration = ((CommonFloat2OrParamType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "deceleration"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "common_float2_or_param_type"), MotionEffectorInfoType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (jerk == null) {
            try {
                jerk = ((CommonFloat2OrParamType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "jerk"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "common_float2_or_param_type"), MotionEffectorInfoType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (newparam == null) {
            try {
                newparam = ((KinematicsNewparamType[]) getChildren(new KinematicsNewparamType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "newparam"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "kinematics_newparam_type"), MotionEffectorInfoType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (bind == null) {
            try {
                bind = ((KinematicsBindType[]) getChildren(new KinematicsBindType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "bind"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "kinematics_bind_type"), MotionEffectorInfoType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
