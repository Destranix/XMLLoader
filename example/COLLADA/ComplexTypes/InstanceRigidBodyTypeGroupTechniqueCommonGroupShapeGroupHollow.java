...
public final class InstanceRigidBodyTypeGroupTechniqueCommonGroupShapeGroupHollow
    extends XmlComplexType
{
    ...
    public InstanceRigidBodyTypeGroupTechniqueCommonGroupShapeGroupHollow(XmlComplexType elem) {
        super(elem, InstanceRigidBodyTypeGroupTechniqueCommonGroupShapeGroupHollow.class);
    }
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, InstanceRigidBodyTypeGroupTechniqueCommonGroupShapeGroupHollow.class);
        }
