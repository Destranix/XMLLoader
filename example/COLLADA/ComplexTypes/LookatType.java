    ...
    extends XmlComplexType
{
    ...
    public LookatType(XmlComplexType elem) {
        super(elem, LookatType.class);
    }
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, LookatType.class);
        }
        ...
        if (XmlSimpleTypePlaceholder.class.isAssignableFrom((children[0].getClass()))) {
            Float3x3Type newChild = new Float3x3Type(((XmlSimpleTypePlaceholder)(children[0])), (((XmlSimpleTypePlaceholder) children[0]).getDataAsString()));
            newChild.setQualifiedName((this.qualifiedName));
            (children)[ 0 ] = newChild;
        }
        return ((Float3x3Type)(children[0])).getValue();
    }
