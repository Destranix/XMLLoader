...
public final class TargetableFloat3Type
    extends XmlComplexType
{
    ...
    public TargetableFloat3Type(XmlComplexType elem) {
        super(elem, TargetableFloat3Type.class);
    }
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, TargetableFloat3Type.class);
        }
