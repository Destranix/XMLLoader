...
public final class Gles2ShaderTypeGroupSources
    extends XmlComplexType
{
    ...
    static {
        ...
        ATTRIBUTE_DEFAULT_VALUES.put("entry", "main");
        try {
    ...
    public Gles2ShaderTypeGroupSources(XmlComplexType elem) {
        super(elem, Gles2ShaderTypeGroupSources.class);
    }
        ...
        throws IOException
    {
        if (inline == null) {
            try {
                inline = ((XmlString[]) getChildren(new XmlString[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "inline"), new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "string"), Gles2ShaderTypeGroupSources.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (importValue == null) {
            try {
                importValue = ((FxSourcesTypeGroupGroup0Import[]) getChildren(new FxSourcesTypeGroupGroup0Import[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "import"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_sources_type/group/group0/import"), Gles2ShaderTypeGroupSources.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
