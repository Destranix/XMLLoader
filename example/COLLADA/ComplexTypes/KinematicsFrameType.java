...
public final class KinematicsFrameType
    extends XmlComplexType
{
    ...
    static {
        ALLOWED_ATTRIBUTES.add("link");
        try {
            ATTRIBUTES_NAME_MAP.put("link", new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "token"));
    ...
    public KinematicsFrameType(XmlComplexType elem) {
        super(elem, KinematicsFrameType.class);
    }
        ...
        throws IOException
    {
        if (translate == null) {
            try {
                translate = ((TranslateType[]) getChildren(new TranslateType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "translate"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "translate_type"), KinematicsFrameType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (rotate == null) {
            try {
                rotate = ((RotateType[]) getChildren(new RotateType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "rotate"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "rotate_type"), KinematicsFrameType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
