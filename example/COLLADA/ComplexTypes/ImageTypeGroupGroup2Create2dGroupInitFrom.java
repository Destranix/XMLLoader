...
public final class ImageTypeGroupGroup2Create2dGroupInitFrom
    extends XmlComplexType
{
    ...
    public ImageTypeGroupGroup2Create2dGroupInitFrom(XmlComplexType elem) {
        super(elem, ImageTypeGroupGroup2Create2dGroupInitFrom.class);
    }
        ...
        throws IOException
    {
        if (hex == null) {
            try {
                hex = ((ImageSourceTypeGroupHex) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "hex"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "image_source_type/group/hex"), ImageTypeGroupGroup2Create2dGroupInitFrom.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (ref == null) {
            try {
                ref = ((XmlAnyURI) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "ref"), new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "anyURI"), ImageTypeGroupGroup2Create2dGroupInitFrom.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
