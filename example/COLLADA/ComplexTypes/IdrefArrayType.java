...
public final class IdrefArrayType
    extends XmlComplexType
{
    ...
    public IdrefArrayType(XmlComplexType elem) {
        super(elem, IdrefArrayType.class);
    }
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, IdrefArrayType.class);
        }
        ...
        if (XmlSimpleTypePlaceholder.class.isAssignableFrom((children[0].getClass()))) {
            XmlIDREFS newChild = new XmlIDREFS(((XmlSimpleTypePlaceholder)(children[0])), (((XmlSimpleTypePlaceholder) children[0]).getDataAsString()));
            newChild.setQualifiedName((this.qualifiedName));
            (children)[ 0 ] = newChild;
        }
        return ((XmlIDREFS)(children[0])).getValue();
    }
