...
public final class TokenArrayType
    extends XmlComplexType
{
    ...
    public TokenArrayType(XmlComplexType elem) {
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, TokenArrayType.class);
        }
        ...
        if (XmlSimpleTypePlaceholder.class.isAssignableFrom((children[0].getClass()))) {
            ListOfTokensType newChild = new ListOfTokensType(((XmlSimpleTypePlaceholder)(children[0])), (((XmlSimpleTypePlaceholder) children[0]).getDataAsString()));
            newChild.setQualifiedName((this.qualifiedName));
            (children)[ 0 ] = newChild;
        }
        return ((ListOfTokensType)(children[0])).getValue();
    }
