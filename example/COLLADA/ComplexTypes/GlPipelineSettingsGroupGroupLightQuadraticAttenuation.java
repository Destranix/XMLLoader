...
public final class GlPipelineSettingsGroupGroupLightQuadraticAttenuation
    extends XmlComplexType
{
    ...
    static {
        ...
        try {
            ...
            ATTRIBUTES_NAME_MAP.put("value", new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "float_type"));
    ...
    public GlPipelineSettingsGroupGroupLightQuadraticAttenuation(XmlComplexType elem) {
        super(elem, GlPipelineSettingsGroupGroupLightQuadraticAttenuation.class);
    }
