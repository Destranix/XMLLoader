...
public final class InstanceRigidBodyTypeGroupTechniqueCommonGroupDynamic
    extends XmlComplexType
{
    ...
    public InstanceRigidBodyTypeGroupTechniqueCommonGroupDynamic(XmlComplexType elem) {
        super(elem, InstanceRigidBodyTypeGroupTechniqueCommonGroupDynamic.class);
    }
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, InstanceRigidBodyTypeGroupTechniqueCommonGroupDynamic.class);
        }
