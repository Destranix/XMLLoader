    ...
    extends XmlComplexType
{
    ...
    public PType(XmlComplexType elem) {
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, PType.class);
        }
        ...
        if (XmlSimpleTypePlaceholder.class.isAssignableFrom((children[0].getClass()))) {
            ListOfUintsType newChild = new ListOfUintsType(((XmlSimpleTypePlaceholder)(children[0])), (((XmlSimpleTypePlaceholder) children[0]).getDataAsString()));
            newChild.setQualifiedName((this.qualifiedName));
            (children)[ 0 ] = newChild;
        }
        return ((ListOfUintsType)(children[0])).getValue();
    }
