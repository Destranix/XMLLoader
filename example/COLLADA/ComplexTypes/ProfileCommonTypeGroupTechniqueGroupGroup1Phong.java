...
public final class ProfileCommonTypeGroupTechniqueGroupGroup1Phong
    extends XmlComplexType
{
    ...
    public ProfileCommonTypeGroupTechniqueGroupGroup1Phong(XmlComplexType elem) {
        super(elem, ProfileCommonTypeGroupTechniqueGroupGroup1Phong.class);
    }
        ...
        throws IOException
    {
        if (diffuse == null) {
            try {
                diffuse = ((FxCommonColorOrTextureType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "diffuse"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_common_color_or_texture_type"), ProfileCommonTypeGroupTechniqueGroupGroup1Phong.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (transparency == null) {
            try {
                transparency = ((FxCommonFloatOrParamType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "transparency"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_common_float_or_param_type"), ProfileCommonTypeGroupTechniqueGroupGroup1Phong.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (indexOfRefraction == null) {
            try {
                indexOfRefraction = ((FxCommonFloatOrParamType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "index_of_refraction"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_common_float_or_param_type"), ProfileCommonTypeGroupTechniqueGroupGroup1Phong.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (reflectivity == null) {
            try {
                reflectivity = ((FxCommonFloatOrParamType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "reflectivity"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_common_float_or_param_type"), ProfileCommonTypeGroupTechniqueGroupGroup1Phong.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (transparent == null) {
            try {
                transparent = ((FxCommonTransparentType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "transparent"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_common_transparent_type"), ProfileCommonTypeGroupTechniqueGroupGroup1Phong.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (emission == null) {
            try {
                emission = ((FxCommonColorOrTextureType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "emission"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_common_color_or_texture_type"), ProfileCommonTypeGroupTechniqueGroupGroup1Phong.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (specular == null) {
            try {
                specular = ((FxCommonColorOrTextureType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "specular"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_common_color_or_texture_type"), ProfileCommonTypeGroupTechniqueGroupGroup1Phong.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (shininess == null) {
            try {
                shininess = ((FxCommonFloatOrParamType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "shininess"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_common_float_or_param_type"), ProfileCommonTypeGroupTechniqueGroupGroup1Phong.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (ambient == null) {
            try {
                ambient = ((FxCommonColorOrTextureType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "ambient"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_common_color_or_texture_type"), ProfileCommonTypeGroupTechniqueGroupGroup1Phong.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (reflective == null) {
            try {
                reflective = ((FxCommonColorOrTextureType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "reflective"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_common_color_or_texture_type"), ProfileCommonTypeGroupTechniqueGroupGroup1Phong.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
