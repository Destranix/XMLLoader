...
public final class Gles2ProgramTypeGroupBindAttribute
    extends XmlComplexType
{
    ...
    public Gles2ProgramTypeGroupBindAttribute(XmlComplexType elem) {
        super(elem, Gles2ProgramTypeGroupBindAttribute.class);
    }
        ...
        throws IOException
    {
        if (semantic == null) {
            try {
                semantic = ((XmlToken) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "semantic"), new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "token"), Gles2ProgramTypeGroupBindAttribute.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
