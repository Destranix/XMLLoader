...
public final class TargetableFloat4Type
    extends XmlComplexType
{
    ...
    public TargetableFloat4Type(XmlComplexType elem) {
        super(elem, TargetableFloat4Type.class);
    }
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, TargetableFloat4Type.class);
        }
        ...
        if (XmlSimpleTypePlaceholder.class.isAssignableFrom((children[0].getClass()))) {
            Float4Type newChild = new Float4Type(((XmlSimpleTypePlaceholder)(children[0])), (((XmlSimpleTypePlaceholder) children[0]).getDataAsString()));
            newChild.setQualifiedName((this.qualifiedName));
            (children)[ 0 ] = newChild;
        }
        return ((Float4Type)(children[0])).getValue();
    }
