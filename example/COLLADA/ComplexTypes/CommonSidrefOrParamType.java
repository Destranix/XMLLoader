...
public final class CommonSidrefOrParamType
    extends XmlComplexType
{
    ...
    public CommonSidrefOrParamType(XmlComplexType elem) {
        super(elem, CommonSidrefOrParamType.class);
    }
        ...
        throws IOException
    {
        if (param == null) {
            try {
                param = ((CommonParamType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "param"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "common_param_type"), CommonSidrefOrParamType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (sIDREF == null) {
            try {
                sIDREF = ((SidrefType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "SIDREF"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "sidref_type"), CommonSidrefOrParamType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
