...
public final class InstanceMaterialTypeGroupBind
    extends XmlComplexType
{
    ...
    public InstanceMaterialTypeGroupBind(XmlComplexType elem) {
        super(elem, InstanceMaterialTypeGroupBind.class);
    }
