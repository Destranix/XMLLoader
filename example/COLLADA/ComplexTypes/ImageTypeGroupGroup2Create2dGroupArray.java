...
public final class ImageTypeGroupGroup2Create2dGroupArray
    extends XmlComplexType
{
    ...
    public ImageTypeGroupGroup2Create2dGroupArray(XmlComplexType elem) {
        super(elem, ImageTypeGroupGroup2Create2dGroupArray.class);
    }
