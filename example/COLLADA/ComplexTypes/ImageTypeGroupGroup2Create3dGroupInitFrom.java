...
public final class ImageTypeGroupGroup2Create3dGroupInitFrom
    extends XmlComplexType
{
    ...
    static {
        ...
        REQUIRED_ATTRIBUTES.add("depth");
        try {
            ATTRIBUTES_NAME_MAP.put("depth", new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "unsignedInt"));
            ATTRIBUTES_NAME_MAP.put("mip_index", new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "unsignedInt"));
            ATTRIBUTES_NAME_MAP.put("array_index", new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "unsignedInt"));
        ...
        ALLOWED_ATTRIBUTES.add("mip_index");
        REQUIRED_ATTRIBUTES.add("mip_index");
        ALLOWED_ATTRIBUTES.add("array_index");
        ATTRIBUTE_DEFAULT_VALUES.put("array_index", "0");
    }

    public ImageTypeGroupGroup2Create3dGroupInitFrom(XmlComplexType elem) {
        super(elem, ImageTypeGroupGroup2Create3dGroupInitFrom.class);
    }
        ...
        throws IOException
    {
        if (hex == null) {
            try {
                hex = ((ImageSourceTypeGroupHex) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "hex"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "image_source_type/group/hex"), ImageTypeGroupGroup2Create3dGroupInitFrom.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (ref == null) {
            try {
                ref = ((XmlAnyURI) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "ref"), new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "anyURI"), ImageTypeGroupGroup2Create3dGroupInitFrom.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
