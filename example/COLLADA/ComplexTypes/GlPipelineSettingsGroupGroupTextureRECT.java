...
public final class GlPipelineSettingsGroupGroupTextureRECT
    extends XmlComplexType
{
    ...
    static {
        ...
        try {
            ...
            CHILDREN_NAME_MAP.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "value"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_samplerRECT_type"));
    ...
    public GlPipelineSettingsGroupGroupTextureRECT(XmlComplexType elem) {
        super(elem, GlPipelineSettingsGroupGroupTextureRECT.class);
    }
        ...
        throws IOException
    {
        if (param == null) {
            try {
                param = ((XmlNCName) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "param"), new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "NCName"), GlPipelineSettingsGroupGroupTextureRECT.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (value == null) {
            try {
                value = ((FxSamplerRECTType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "value"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_samplerRECT_type"), GlPipelineSettingsGroupGroupTextureRECT.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
