...
public final class RigidConstraintTypeGroupTechniqueCommonGroupSpringGroupAngular
    extends XmlComplexType
{
    ...
    public RigidConstraintTypeGroupTechniqueCommonGroupSpringGroupAngular(XmlComplexType elem) {
        super(elem, RigidConstraintTypeGroupTechniqueCommonGroupSpringGroupAngular.class);
    }
        ...
        throws IOException
    {
        if (damping == null) {
            try {
                damping = ((TargetableFloatType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "damping"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "targetable_float_type"), RigidConstraintTypeGroupTechniqueCommonGroupSpringGroupAngular.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (stiffness == null) {
            try {
                stiffness = ((TargetableFloatType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "stiffness"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "targetable_float_type"), RigidConstraintTypeGroupTechniqueCommonGroupSpringGroupAngular.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (targetValue == null) {
            try {
                targetValue = ((TargetableFloatType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "target_value"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "targetable_float_type"), RigidConstraintTypeGroupTechniqueCommonGroupSpringGroupAngular.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
