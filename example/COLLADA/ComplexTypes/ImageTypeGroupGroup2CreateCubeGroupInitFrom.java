...
public final class ImageTypeGroupGroup2CreateCubeGroupInitFrom
    extends XmlComplexType
{
    ...
    public ImageTypeGroupGroup2CreateCubeGroupInitFrom(XmlComplexType elem) {
        super(elem, ImageTypeGroupGroup2CreateCubeGroupInitFrom.class);
    }
        ...
        throws IOException
    {
        if (hex == null) {
            try {
                hex = ((ImageSourceTypeGroupHex) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "hex"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "image_source_type/group/hex"), ImageTypeGroupGroup2CreateCubeGroupInitFrom.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (ref == null) {
            try {
                ref = ((XmlAnyURI) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "ref"), new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "anyURI"), ImageTypeGroupGroup2CreateCubeGroupInitFrom.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
