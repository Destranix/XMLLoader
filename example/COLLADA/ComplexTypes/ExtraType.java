    ...
    extends XmlComplexType
{
    ...
    protected final static String ALLOWED_CHILDREN_PATTERN = "((asset[ ]+){0,1}(technique[ ]+){1,}){1}";
    ...
    static {
        ...
        try {
            ...
            ATTRIBUTES_NAME_MAP.put("type", new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "NMTOKEN"));
    ...
    public ExtraType(XmlComplexType elem) {
        super(elem, ExtraType.class);
    }
        ...
        throws IOException
    {
        if (asset == null) {
            try {
                asset = ((AssetType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "asset"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "asset_type"), ExtraType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (technique == null) {
            try {
                technique = ((TechniqueType[]) getChildren(new TechniqueType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "technique"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "technique_type"), ExtraType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
