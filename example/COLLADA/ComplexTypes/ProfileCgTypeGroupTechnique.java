...
public final class ProfileCgTypeGroupTechnique
    extends XmlComplexType
{
    ...
    static {
        ...
        try {
            ...
            CHILDREN_NAME_MAP.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "pass"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "cg_pass_type"));
    ...
    public ProfileCgTypeGroupTechnique(XmlComplexType elem) {
        super(elem, ProfileCgTypeGroupTechnique.class);
    }
        ...
        throws IOException
    {
        if (extra == null) {
            try {
                extra = ((ExtraType[]) getChildren(new ExtraType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra_type"), ProfileCgTypeGroupTechnique.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (annotate == null) {
            try {
                annotate = ((FxAnnotateType[]) getChildren(new FxAnnotateType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "annotate"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_annotate_type"), ProfileCgTypeGroupTechnique.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
    ...
    public CgPassType[] getPass()
        throws IOException
    {
        if (pass == null) {
            try {
                pass = ((CgPassType[]) getChildren(new CgPassType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "pass"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "cg_pass_type"), ProfileCgTypeGroupTechnique.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (asset == null) {
            try {
                asset = ((AssetType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "asset"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "asset_type"), ProfileCgTypeGroupTechnique.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
