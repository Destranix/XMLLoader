...
public final class InstanceRigidBodyType
    extends XmlComplexType
{
    ...
    protected InstanceRigidBodyTypeGroupTechniqueCommon techniqueCommon;
    ...
    static {
        ...
        try {
            ...
            ATTRIBUTES_NAME_MAP.put("body", new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "NCName"));
            ...
            CHILDREN_NAME_MAP.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "technique_common"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "instance_rigid_body_type/group/technique_common"));
        ...
        ALLOWED_ATTRIBUTES.add("body");
        REQUIRED_ATTRIBUTES.add("body");
    }

    public InstanceRigidBodyType(XmlComplexType elem) {
        super(elem, InstanceRigidBodyType.class);
    }
        ...
        throws IOException
    {
        if (extra == null) {
            try {
                extra = ((ExtraType[]) getChildren(new ExtraType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra_type"), InstanceRigidBodyType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
    ...
    public InstanceRigidBodyTypeGroupTechniqueCommon getTechniqueCommon()
        throws IOException
    {
        if (techniqueCommon == null) {
            try {
                techniqueCommon = ((InstanceRigidBodyTypeGroupTechniqueCommon) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "technique_common"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "instance_rigid_body_type/group/technique_common"), InstanceRigidBodyType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (technique == null) {
            try {
                technique = ((TechniqueType[]) getChildren(new TechniqueType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "technique"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "technique_type"), InstanceRigidBodyType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
