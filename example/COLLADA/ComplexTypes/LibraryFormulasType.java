...
public final class LibraryFormulasType
    extends XmlComplexType
{

    protected final static String ALLOWED_CHILDREN_PATTERN = "((asset[ ]+){0,1}(formula[ ]+){1,}(extra[ ]+){0,}){1}";
    ...
    static {
        ...
        try {
            ...
            ALLOWED_CHILDREN_MIN_BOUNDS.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "formula"), Integer.valueOf("1"));
    ...
    public LibraryFormulasType(XmlComplexType elem) {
        super(elem, LibraryFormulasType.class);
    }
        ...
        throws IOException
    {
        if (extra == null) {
            try {
                extra = ((ExtraType[]) getChildren(new ExtraType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra_type"), LibraryFormulasType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (formula == null) {
            try {
                formula = ((FormulaType[]) getChildren(new FormulaType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "formula"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "formula_type"), LibraryFormulasType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (asset == null) {
            try {
                asset = ((AssetType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "asset"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "asset_type"), LibraryFormulasType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
