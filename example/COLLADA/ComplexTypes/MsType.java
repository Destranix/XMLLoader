    ...
    extends XmlComplexType
{
    ...
    static {
        ...
        try {
            ...
            ATTRIBUTES_NAME_MAP.put("lquote", new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "string"));
            ...
            ATTRIBUTES_NAME_MAP.put("rquote", new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "string"));
        ...
        ALLOWED_ATTRIBUTES.add("lquote");
        ATTRIBUTE_DEFAULT_VALUES.put("lquote", "\"");
        ...
        throws IOException
    {
        if (malignmark == null) {
            try {
                malignmark = ((MalignmarkType) getChild(new XmlQName(new URI("http://www.w3.org/1998/Math/MathML"), "malignmark"), new XmlQName(new URI("http://www.w3.org/1998/Math/MathML"), "malignmark.type"), MsType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (mglyph == null) {
            try {
                mglyph = ((MglyphType) getChild(new XmlQName(new URI("http://www.w3.org/1998/Math/MathML"), "mglyph"), new XmlQName(new URI("http://www.w3.org/1998/Math/MathML"), "mglyph.type"), MsType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
