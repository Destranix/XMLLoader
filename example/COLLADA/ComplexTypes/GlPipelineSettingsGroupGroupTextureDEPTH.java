...
public final class GlPipelineSettingsGroupGroupTextureDEPTH
    extends XmlComplexType
{
    ...
    static {
        ...
        try {
            ...
            CHILDREN_NAME_MAP.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "value"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_samplerDEPTH_type"));
    ...
    public GlPipelineSettingsGroupGroupTextureDEPTH(XmlComplexType elem) {
        super(elem, GlPipelineSettingsGroupGroupTextureDEPTH.class);
    }
        ...
        throws IOException
    {
        if (param == null) {
            try {
                param = ((XmlNCName) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "param"), new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "NCName"), GlPipelineSettingsGroupGroupTextureDEPTH.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (value == null) {
            try {
                value = ((FxSamplerDEPTHType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "value"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_samplerDEPTH_type"), GlPipelineSettingsGroupGroupTextureDEPTH.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
