...
public final class MalignmarkType
    extends XmlComplexType
{
    ...
    static {
        ...
        try {
            ...
            ATTRIBUTES_NAME_MAP.put("edge", new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "attribute/type"));
        ...
        ALLOWED_ATTRIBUTES.add("edge");
        ATTRIBUTE_DEFAULT_VALUES.put("edge", "left");
    ...
    public MalignmarkType(XmlComplexType elem) {
        super(elem, MalignmarkType.class);
    }
