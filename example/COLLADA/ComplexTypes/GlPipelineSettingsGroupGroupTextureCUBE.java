...
public final class GlPipelineSettingsGroupGroupTextureCUBE
    extends XmlComplexType
{
    ...
    static {
        ...
        try {
            ...
            CHILDREN_NAME_MAP.put(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "value"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_samplerCUBE_type"));
    ...
    public GlPipelineSettingsGroupGroupTextureCUBE(XmlComplexType elem) {
        super(elem, GlPipelineSettingsGroupGroupTextureCUBE.class);
    }
        ...
        throws IOException
    {
        if (param == null) {
            try {
                param = ((XmlNCName) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "param"), new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "NCName"), GlPipelineSettingsGroupGroupTextureCUBE.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (value == null) {
            try {
                value = ((FxSamplerCUBEType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "value"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_samplerCUBE_type"), GlPipelineSettingsGroupGroupTextureCUBE.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
