    ...
    extends XmlComplexType
{
    ...
    public TranslateType(XmlComplexType elem) {
        super(elem, TranslateType.class);
    }
        ...
        throws IOException, ParseException
    {
        if (this.children == null) {
            loadChildren(true, true, TranslateType.class);
        }
        ...
        if (XmlSimpleTypePlaceholder.class.isAssignableFrom((children[0].getClass()))) {
            TranslateType.SimpleTypeClass newChild = new TranslateType.SimpleTypeClass(((XmlSimpleTypePlaceholder)(children[0])), (((XmlSimpleTypePlaceholder) children[0]).getDataAsString()));
            newChild.setQualifiedName((this.qualifiedName));
            (children)[ 0 ] = newChild;
        }
        return ((TranslateType.SimpleTypeClass)(children[0])).getValue();
    }
        ...
        extends XmlSimpleType
    {
        ...
        {
            super(attr);
            this.value = TranslateType.SimpleTypeClass.parseAndCheckValue(value, this.file);
        }
        ...
        public static double[] parseAndCheckValue(String value, XmlFile file)
            throws ParseException
        {
            String tmp = TranslateType.SimpleTypeClass.applyLexicalFacets(value, file);
            double[] ret = TranslateType.SimpleTypeClass.parseValue(tmp);
            TranslateType.SimpleTypeClass.checkValueBasedFacets(ret);
            return ret;
        }

        public static double[] parseValue(String value) {
            double[] ret = ((double[]) Float3Type.parseValue(value));
            return ret;
        }
