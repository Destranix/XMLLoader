...
public final class ConvexMeshType
    extends XmlComplexType
{

    protected final static String ALLOWED_CHILDREN_PATTERN = "(((source[ ]+){1,}(vertices[ ]+){1}(lines[ ]+){1}|(linestrips[ ]+){1}|(polygons[ ]+){1}|(polylist[ ]+){1}|(triangles[ ]+){1}|(trifans[ ]+){1}|(tristrips[ ]+){1}){0,}(extra[ ]+){0,}){0,1}";
    ...
    static {
        ALLOWED_ATTRIBUTES.add("convex_hull_of");
        try {
            ATTRIBUTES_NAME_MAP.put("convex_hull_of", new XmlQName(new URI("http://www.w3.org/2001/XMLSchema"), "anyURI"));
    ...
    public ConvexMeshType(XmlComplexType elem) {
        super(elem, ConvexMeshType.class);
    }
        ...
        throws IOException
    {
        if (extra == null) {
            try {
                extra = ((ExtraType[]) getChildren(new ExtraType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "extra_type"), ConvexMeshType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (trifans == null) {
            try {
                trifans = ((TrifansType[]) getChildren(new TrifansType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "trifans"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "trifans_type"), ConvexMeshType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (vertices == null) {
            try {
                vertices = ((VerticesType[]) getChildren(new VerticesType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "vertices"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "vertices_type"), ConvexMeshType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (polygons == null) {
            try {
                polygons = ((PolygonsType[]) getChildren(new PolygonsType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "polygons"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "polygons_type"), ConvexMeshType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (lines == null) {
            try {
                lines = ((LinesType[]) getChildren(new LinesType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "lines"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "lines_type"), ConvexMeshType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (tristrips == null) {
            try {
                tristrips = ((TristripsType[]) getChildren(new TristripsType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "tristrips"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "tristrips_type"), ConvexMeshType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (triangles == null) {
            try {
                triangles = ((TrianglesType[]) getChildren(new TrianglesType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "triangles"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "triangles_type"), ConvexMeshType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (linestrips == null) {
            try {
                linestrips = ((LinestripsType[]) getChildren(new LinestripsType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "linestrips"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "linestrips_type"), ConvexMeshType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (polylist == null) {
            try {
                polylist = ((PolylistType[]) getChildren(new PolylistType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "polylist"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "polylist_type"), ConvexMeshType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (source == null) {
            try {
                source = ((SourceType[]) getChildren(new SourceType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "source"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "source_type"), ConvexMeshType.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
