...
public final class CgPassTypeGroupEvaluate
    extends XmlComplexType
{
    ...
    public CgPassTypeGroupEvaluate(XmlComplexType elem) {
        super(elem, CgPassTypeGroupEvaluate.class);
    }
        ...
        throws IOException
    {
        if (draw == null) {
            try {
                draw = ((FxDrawType) getChild(new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "draw"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_draw_type"), CgPassTypeGroupEvaluate.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (colorClear == null) {
            try {
                colorClear = ((FxClearcolorType[]) getChildren(new FxClearcolorType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "color_clear"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_clearcolor_type"), CgPassTypeGroupEvaluate.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (depthClear == null) {
            try {
                depthClear = ((FxCleardepthType[]) getChildren(new FxCleardepthType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "depth_clear"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_cleardepth_type"), CgPassTypeGroupEvaluate.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (depthTarget == null) {
            try {
                depthTarget = ((FxDepthtargetType[]) getChildren(new FxDepthtargetType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "depth_target"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_depthtarget_type"), CgPassTypeGroupEvaluate.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (stencilClear == null) {
            try {
                stencilClear = ((FxClearstencilType[]) getChildren(new FxClearstencilType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "stencil_clear"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_clearstencil_type"), CgPassTypeGroupEvaluate.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (stencilTarget == null) {
            try {
                stencilTarget = ((FxStenciltargetType[]) getChildren(new FxStenciltargetType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "stencil_target"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_stenciltarget_type"), CgPassTypeGroupEvaluate.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
        ...
        throws IOException
    {
        if (colorTarget == null) {
            try {
                colorTarget = ((FxColortargetType[]) getChildren(new FxColortargetType[ 0 ] , new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "color_target"), new XmlQName(new URI("http://www.collada.org/2008/03/COLLADASchema"), "fx_colortarget_type"), CgPassTypeGroupEvaluate.class));
            } catch (URISyntaxException e) {
                throw new AssertionError("URI not parsable", e);
            }
        }
