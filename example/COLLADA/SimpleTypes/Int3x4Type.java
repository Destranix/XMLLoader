...
public class Int3x4Type
    extends XmlSimpleType
{

    protected final ArrayBigList<Long> value;

    public Int3x4Type(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = Int3x4Type.parseAndCheckValue(value, this.file);
    }
    ...
    public static ArrayBigList<Long> parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = Int3x4Type.applyLexicalFacets(value, file);
        ArrayBigList<Long> ret = Int3x4Type.parseValue(tmp, file);
        Int3x4Type.checkValueBasedFacets(ret);
        return ret;
    }
