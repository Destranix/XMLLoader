...
public class GlShadeModelEnum
    extends XmlSimpleType
{

    protected final String value;
    private final static Pattern RESTRICTION_PATTERN = (Pattern.compile("FLAT|SMOOTH"));

    public GlShadeModelEnum(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = GlShadeModelEnum.parseAndCheckValue(value, this.file);
    }
    ...
    public static String parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = GlShadeModelEnum.applyLexicalFacets(value, file);
        String ret = GlShadeModelEnum.parseValue(tmp);
        GlShadeModelEnum.checkValueBasedFacets(ret);
        return ret;
    }
