    ...
    extends XmlSimpleType
{
    ...
    private final static Pattern RESTRICTION_PATTERN = (Pattern.compile("LINEAR|ANGULAR"));

    public SpringEnum(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = SpringEnum.parseAndCheckValue(value, this.file);
    }
    ...
    public static String parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = SpringEnum.applyLexicalFacets(value, file);
        String ret = SpringEnum.parseValue(tmp);
        SpringEnum.checkValueBasedFacets(ret);
        return ret;
    }
