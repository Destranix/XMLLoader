    ...
    extends XmlSimpleType
{
    ...
    private final static Pattern RESTRICTION_PATTERN = (Pattern.compile("left|center|right"));

    public Centering(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = Centering.parseAndCheckValue(value, this.file);
    }
    ...
    public static String parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = Centering.applyLexicalFacets(value, file);
        String ret = Centering.parseValue(tmp);
        Centering.checkValueBasedFacets(ret);
        return ret;
    }
