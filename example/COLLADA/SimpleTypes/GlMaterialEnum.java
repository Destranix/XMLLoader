...
public class GlMaterialEnum
    extends XmlSimpleType
{

    protected final String value;
    private final static Pattern RESTRICTION_PATTERN = (Pattern.compile("AMBIENT|DIFFUSE|SPECULAR|EMISSION|AMBIENT_AND_DIFFUSE"));

    public GlMaterialEnum(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = GlMaterialEnum.parseAndCheckValue(value, this.file);
    }
    ...
    public static String parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = GlMaterialEnum.applyLexicalFacets(value, file);
        String ret = GlMaterialEnum.parseValue(tmp);
        GlMaterialEnum.checkValueBasedFacets(ret);
        return ret;
    }
