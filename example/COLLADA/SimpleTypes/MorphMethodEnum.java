...
public class MorphMethodEnum
    extends XmlSimpleType
{

    protected final String value;
    private final static Pattern RESTRICTION_PATTERN = (Pattern.compile("RELATIVE|NORMALIZED"));

    public MorphMethodEnum(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = MorphMethodEnum.parseAndCheckValue(value, this.file);
    }
    ...
    public static String parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = MorphMethodEnum.applyLexicalFacets(value, file);
        String ret = MorphMethodEnum.parseValue(tmp);
        MorphMethodEnum.checkValueBasedFacets(ret);
        return ret;
    }
