    ...
    extends XmlSimpleType
{
    ...
    public UrifragmentType(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = UrifragmentType.parseAndCheckValue(value, this.file);
    }
    ...
    public static String parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = UrifragmentType.applyLexicalFacets(value, file);
        String ret = UrifragmentType.parseValue(tmp);
        UrifragmentType.checkValueBasedFacets(ret);
        return ret;
    }
