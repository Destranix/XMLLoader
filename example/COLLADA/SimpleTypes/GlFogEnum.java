    ...
    extends XmlSimpleType
{
    ...
    {
        super(attr);
        this.value = GlFogEnum.parseAndCheckValue(value, this.file);
    }
    ...
    public static String parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = GlFogEnum.applyLexicalFacets(value, file);
        String ret = GlFogEnum.parseValue(tmp);
        GlFogEnum.checkValueBasedFacets(ret);
        return ret;
    }
