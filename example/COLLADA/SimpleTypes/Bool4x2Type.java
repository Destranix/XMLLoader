...
public class Bool4x2Type
    extends XmlSimpleType
{

    protected final ArrayBigList<Boolean> value;

    public Bool4x2Type(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = Bool4x2Type.parseAndCheckValue(value, this.file);
    }
    ...
    public static ArrayBigList<Boolean> parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = Bool4x2Type.applyLexicalFacets(value, file);
        ArrayBigList<Boolean> ret = Bool4x2Type.parseValue(tmp, file);
        Bool4x2Type.checkValueBasedFacets(ret);
        return ret;
    }
