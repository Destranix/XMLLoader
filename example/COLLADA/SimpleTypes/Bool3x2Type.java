...
public class Bool3x2Type
    extends XmlSimpleType
{

    protected final ArrayBigList<Boolean> value;

    public Bool3x2Type(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = Bool3x2Type.parseAndCheckValue(value, this.file);
    }
    ...
    public static ArrayBigList<Boolean> parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = Bool3x2Type.applyLexicalFacets(value, file);
        ArrayBigList<Boolean> ret = Bool3x2Type.parseValue(tmp, file);
        Bool3x2Type.checkValueBasedFacets(ret);
        return ret;
    }
