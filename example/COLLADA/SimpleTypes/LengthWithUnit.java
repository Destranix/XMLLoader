    ...
    extends XmlSimpleType
{
    ...
    private final static Pattern RESTRICTION_PATTERN = (Pattern.compile("(-?([0-9]+|[0-9]*\\.[0-9]+)*(em|ex|px|in|cm|mm|pt|pc|%))|0"));

    public LengthWithUnit(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = LengthWithUnit.parseAndCheckValue(value, this.file);
    }
    ...
    public static String parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = LengthWithUnit.applyLexicalFacets(value, file);
        String ret = LengthWithUnit.parseValue(tmp);
        LengthWithUnit.checkValueBasedFacets(ret);
        return ret;
    }
