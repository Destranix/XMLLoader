...
public class GlEnumerationType
    extends XmlSimpleType
{

    protected final String value;

    public GlEnumerationType(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = GlEnumerationType.parseAndCheckValue(value, this.file);
    }
        ...
        throws ParseException
    {
        ...
        if ((!couldParse)) {
            try {
                tmp = GlFogCoordSrcEnum.applyLexicalFacets(value, file);
                GlFogCoordSrcEnum.checkValueBasedFacets(GlFogCoordSrcEnum.parseValue(tmp));
            } catch (XmlValidationException _x) {
            }
        }
        if ((!couldParse)) {
        ...
        String ret = GlEnumerationType.parseValue(tmp);
        return ret;
    }
