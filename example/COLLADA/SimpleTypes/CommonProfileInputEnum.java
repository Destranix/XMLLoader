    ...
    extends XmlSimpleType
{
    ...
    private final static Pattern RESTRICTION_PATTERN = (Pattern.compile("BINORMAL|UV|INV_BIND_MATRIX|INPUT|OUTPUT|TANGENT|MORPH_TARGET|OUT_TANGENT|LINEAR_STEPS|TEXTANGENT|INTERPOLATION|POSITION|CONTINUITY|IMAGE|IN_TANGENT|COLOR|VERTEX|MORPH_WEIGHT|WEIGHT|JOINT|NORMAL|TEXCOORD|TEXBINORMAL"));
