...
public class GlMaxTextureImageUnitsIndexType
    extends XmlSimpleType
{

    protected final BigInteger value;

    public GlMaxTextureImageUnitsIndexType(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = GlMaxTextureImageUnitsIndexType.parseAndCheckValue(value, this.file);
    }
    ...
    public static BigInteger parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = GlMaxTextureImageUnitsIndexType.applyLexicalFacets(value, file);
        BigInteger ret = GlMaxTextureImageUnitsIndexType.parseValue(tmp);
        GlMaxTextureImageUnitsIndexType.checkValueBasedFacets(ret);
        return ret;
    }
    ...
    public static void checkValueBasedFacets(BigInteger value) {
        ...
        final BigInteger minInclusive = GlMaxTextureImageUnitsIndexType.parseValue("0");
