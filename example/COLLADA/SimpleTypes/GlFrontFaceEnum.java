...
public class GlFrontFaceEnum
    extends XmlSimpleType
{

    protected final String value;
    private final static Pattern RESTRICTION_PATTERN = (Pattern.compile("CW|CCW"));

    public GlFrontFaceEnum(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = GlFrontFaceEnum.parseAndCheckValue(value, this.file);
    }
    ...
    public static String parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = GlFrontFaceEnum.applyLexicalFacets(value, file);
        String ret = GlFrontFaceEnum.parseValue(tmp);
        GlFrontFaceEnum.checkValueBasedFacets(ret);
        return ret;
    }
