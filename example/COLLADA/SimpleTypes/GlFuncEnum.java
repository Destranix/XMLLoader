...
public class GlFuncEnum
    extends XmlSimpleType
{

    protected final String value;
    private final static Pattern RESTRICTION_PATTERN = (Pattern.compile("NOTEQUAL|EQUAL|NEVER|GEQUAL|GREATER|LEQUAL|LESS|ALWAYS"));

    public GlFuncEnum(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = GlFuncEnum.parseAndCheckValue(value, this.file);
    }
    ...
    public static String parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = GlFuncEnum.applyLexicalFacets(value, file);
        String ret = GlFuncEnum.parseValue(tmp);
        GlFuncEnum.checkValueBasedFacets(ret);
        return ret;
    }
