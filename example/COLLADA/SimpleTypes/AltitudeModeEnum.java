...
public class AltitudeModeEnum
    extends XmlSimpleType
{

    protected final String value;
    private final static Pattern RESTRICTION_PATTERN = (Pattern.compile("relativeToGround|absolute"));

    public AltitudeModeEnum(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = AltitudeModeEnum.parseAndCheckValue(value, this.file);
    }
    ...
    public static String parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = AltitudeModeEnum.applyLexicalFacets(value, file);
        String ret = AltitudeModeEnum.parseValue(tmp);
        AltitudeModeEnum.checkValueBasedFacets(ret);
        return ret;
    }
