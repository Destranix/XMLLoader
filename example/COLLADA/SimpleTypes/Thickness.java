    ...
    extends XmlSimpleType
{
    ...
    private final static Pattern RESTRICTION_PATTERN = (Pattern.compile("medium|thick|thin"));

    public Thickness(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = Thickness.parseAndCheckValue(value, this.file);
    }
    ...
    public static String parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = Thickness.applyLexicalFacets(value, file);
        String ret = Thickness.parseValue(tmp);
        Thickness.checkValueBasedFacets(ret);
        return ret;
    }
