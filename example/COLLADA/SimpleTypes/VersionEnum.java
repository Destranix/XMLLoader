    ...
    extends XmlSimpleType
{
    ...
    private final static Pattern RESTRICTION_PATTERN = (Pattern.compile("1.5.0"));

    public VersionEnum(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = VersionEnum.parseAndCheckValue(value, this.file);
    }
    ...
    public static String parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = VersionEnum.applyLexicalFacets(value, file);
        String ret = VersionEnum.parseValue(tmp);
        VersionEnum.checkValueBasedFacets(ret);
        return ret;
    }
