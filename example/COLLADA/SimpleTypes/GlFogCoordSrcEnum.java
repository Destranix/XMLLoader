...
public class GlFogCoordSrcEnum
    extends XmlSimpleType
{

    protected final String value;
    private final static Pattern RESTRICTION_PATTERN = (Pattern.compile("FOG_COORDINATE|FRAGMENT_DEPTH"));

    public GlFogCoordSrcEnum(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = GlFogCoordSrcEnum.parseAndCheckValue(value, this.file);
    }
    ...
    public static String parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = GlFogCoordSrcEnum.applyLexicalFacets(value, file);
        String ret = GlFogCoordSrcEnum.parseValue(tmp);
        GlFogCoordSrcEnum.checkValueBasedFacets(ret);
        return ret;
    }
