    ...
    extends XmlSimpleType
{
    ...
    private final static Pattern RESTRICTION_PATTERN = (Pattern.compile("infinity"));

    public Infinity(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = Infinity.parseAndCheckValue(value, this.file);
    }
    ...
    public static String parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = Infinity.applyLexicalFacets(value, file);
        String ret = Infinity.parseValue(tmp);
        Infinity.checkValueBasedFacets(ret);
        return ret;
    }
