...
public class GlesStencilOpEnum
    extends XmlSimpleType
{

    protected final String value;
    private final static Pattern RESTRICTION_PATTERN = (Pattern.compile("ZERO|INVERT|KEEP|INCR|REPLACE|DECR"));

    public GlesStencilOpEnum(XmlSimpleType attr, String value)
        throws ParseException
    {
        super(attr);
        this.value = GlesStencilOpEnum.parseAndCheckValue(value, this.file);
    }
    ...
    public static String parseAndCheckValue(String value, XmlFile file)
        throws ParseException
    {
        String tmp = GlesStencilOpEnum.applyLexicalFacets(value, file);
        String ret = GlesStencilOpEnum.parseValue(tmp);
        GlesStencilOpEnum.checkValueBasedFacets(ret);
        return ret;
    }
