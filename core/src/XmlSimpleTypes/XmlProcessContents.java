...
public class XmlProcessContents extends XmlSimpleType{
	
	private static final Pattern RESTRICTION_PATTERN = Pattern.compile("skip|lax|strict");
	protected final String value;
	
	public XmlProcessContents(XmlSimpleType attr, String value) throws ParseException{
		super(attr);
