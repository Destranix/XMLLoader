...
public class XmlDate extends XmlSimpleType{
	
	private static final DateTimeFormatter FORMATTER = DateTimeFormatter.ofPattern("['-']yyyy'-'MM'-'dd[XXXXX]");
	
	protected final TemporalAccessor value;
	
	public XmlDate(XmlSimpleType attr, String value) throws ParseException{
		super(attr);
