...
public class XmlNegativeInteger extends XmlSimpleType{
	
	protected final BigInteger value;
	
	public XmlNegativeInteger(XmlSimpleType attr, String value) throws ParseException{
		super(attr);
	...
	public static void checkValueBasedFacets(BigInteger value){
		if(BigInteger.ZERO.compareTo(value) <= 0){
			throw new XmlValidationException("Value must be negative: "+value);
		}
	}
