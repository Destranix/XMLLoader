...
public class XmlString extends XmlSimpleType{
	
	protected final String value;
	
	public XmlString(XmlSimpleType attr, String value) throws ParseException{
		super(attr);
	...
	public static String applyLexicalFacets(String value, XmlFile file) throws ParseException{
		String tmp = normalize(value, false, file);
		return tmp;
	}
