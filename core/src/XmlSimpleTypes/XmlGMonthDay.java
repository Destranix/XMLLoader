...
public class XmlGMonthDay extends XmlSimpleType{
	
	private static final DateTimeFormatter FORMATTER = DateTimeFormatter.ofPattern("'-'MM'-'dd[XXXXX]");
	
	protected final TemporalAccessor value;
	
	public XmlGMonthDay(XmlSimpleType attr, String value) throws ParseException{
		super(attr);
