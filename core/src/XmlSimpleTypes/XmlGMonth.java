...
public class XmlGMonth extends XmlSimpleType{
	
	private static final DateTimeFormatter FORMATTER = DateTimeFormatter.ofPattern("'-'MM[XXXXX]");
	
	protected final TemporalAccessor value;
	
	public XmlGMonth(XmlSimpleType attr, String value) throws ParseException{
		super(attr);
