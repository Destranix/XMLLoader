...
public class XmlSpace extends XmlSimpleType{
	
	private static final Pattern RESTRICTION_PATTERN = Pattern.compile("default|preserve");	
	protected final String value;
	
	public XmlSpace(XmlSimpleType attr, String value) throws ParseException{
		super(attr);
