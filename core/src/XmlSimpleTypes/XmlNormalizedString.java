...
public class XmlNormalizedString extends XmlSimpleType{
	
	protected final String value;
	
	public XmlNormalizedString(XmlSimpleType attr, String value) throws ParseException{
		super(attr);
	...
	public static String applyLexicalFacets(String value, XmlFile file) throws ParseException{
		String tmp = normalize(value, true, file);
		return tmp;
	}
