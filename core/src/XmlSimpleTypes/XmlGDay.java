...
public class XmlGDay extends XmlSimpleType{
	
	private static final DateTimeFormatter FORMATTER = DateTimeFormatter.ofPattern("'-''-'dd[XXXXX]");
	
	protected final TemporalAccessor value;
	
	public XmlGDay(XmlSimpleType attr, String value) throws ParseException{
		super(attr);
